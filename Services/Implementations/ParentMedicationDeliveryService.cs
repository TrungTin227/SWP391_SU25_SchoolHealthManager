    ...
    public class ParentMedicationDeliveryService : BaseService<ParentMedicationDelivery, Guid>, IParentMedicationDeliveryService
    {
        ...
        public async Task<ApiResult<ParentMedicationDeliveryResponseDTO>> CreateDeliveryAsync(CreateParentMedicationDeliveryRequestDTO request)
        {
            try
            {
                ...
                {
                    _logger.LogError("Thời gian hiện tại không hợp lệ. Chỉ cho phép tạo phiếu giao thuốc trong giờ làm việc (07:00 - 23:00)");
                    return ApiResult<ParentMedicationDeliveryResponseDTO>.Failure(new ArgumentException("Chỉ cho phép tạo phiếu giao thuốc trong giờ làm việc (07:00 - 23:00)"));
                }
