    ...
    public partial class SchoolHealthManagerInitial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalSupplyLots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicalSupplyLots_MedicalSupplies_MedicalSupplyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisionLeft = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    VisionRight = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Hearing = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HealthEventId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicalSupplyLotId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SupplyUsages_MedicalSupplyLots_MedicalSupplyLotId",
                        column: x => x.MedicalSupplyLotId,
                        principalTable: "MedicalSupplyLots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalSupplyLots_MedicalSupplyId",
                table: "MedicalSupplyLots",
